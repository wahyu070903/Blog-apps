	...
	<div class="row d-flex align-items-center justify-content-center" style="width:100vw; height:100vh">
		<div class="col-md-8">
			<div class="card">
				<div class="row gx-0">
					<div class="col">
						<img class="left-img" src="{{asset('images/app/rocket.jpg')}}">
					</div>
					<div class="col login-column">
						...
						<div class="row gx-2">
							...
							<div class="col">
								<a class="facebook-login btn" href="#"><img class="service-logo" src="{{asset('images/app/facebook.png')}}"><span>Log In with Facebook</span></a>	
							</div>
						</div>
						<div class="break-row">
						...
						<div class="row">
							<form method="post" action="{{url('auth/login')}}">
								...
								<button class="btn register-button text-nowrap" type="submit" disabled>Log In</button>
							</form>
						</div>
					</div>
				</div>
